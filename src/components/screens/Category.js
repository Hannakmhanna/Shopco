...
import filterIcon from "../../assests/images/Frame (2).png";
import image1 from "../../assests/images/Frame 33 (1).png";
import image2 from "../../assests/images/Frame 34.png";
import image3 from "../../assests/images/Frame 38 (1).png";
import image4 from "../../assests/images/geens.png";
import image5 from "../../assests/images/image 9.png";
import image6 from "../../assests/images/shirtmens.png";
import image7 from "../../assests/images/Frame 32 (1).png";
import image8 from "../../assests/images/Frame 70.png";
import image9 from "../../assests/images/Frame 71.png";
import mailIcon from "../../assests/images/message.png";

const Category = () => {
  const [activeColor, setActiveColor] = useState(null); // Track the active colo
  const [filtersVisible, setFiltersVisible] = useState(false); // Manage visibility of filters
  ...
  const products = [
    ...
    { id: 5, name: "Checkered Shirt", price: "$140", image: image5, rating: 5 }, // Ensure it's within range
    {
      id: 6,
    ...
    return (
      <div style={{ display: "flex", alignItems: "center" }}>
        ...
        {halfStar && (
          <span
            key="half"
            style={{ position: "relative", fontSize: "20px", color: "gold" }}
          >
            <span
              style={{
        ...
        {[...Array(emptyStars)].map((_, index) => (
          <span
            key={`empty-${index}`}
            style={{ color: "#FFC633", fontSize: "20px" }}
          >
            ★
          </span>
        ))}
  ...
  return (
    <Wrapper>
      ...
      <Breadcrumb>
        ...
        <Separator>›</Separator>
        <BreadcrumbItem href="/casual">Casual</BreadcrumbItem>
      </Breadcrumb>
      <Container>
      <FilterIconWrapper>
          <img
            src={filterIcon} // Path to your filter icon image
            alt="Filter Icon"
            className="filter-icon"
            onClick={handleToggleFilters} // Toggle filters on click
          />
        </FilterIconWrapper>
          ...
          <FilterSection title="Colors">
            ...
            <ColorOptions>
              {[
                ...
                >
                  {activeColor === color && <Tick>✔</Tick>}{" "}
                  {/* Show tick on active color */}
                </Color>
              ))}
            </ColorOptions>
          </FilterSection>
...
const Color = styled.div`
  ...
  border: ${(props) =>
    props.active
      ? "3px solid #007bff"
      : "1px solid #ccc"}; /* Active color highlight */
  box-shadow: ${(props) =>
    props.active
      ? "0px 0px 8px rgba(0, 123, 255, 0.7)"
...
const FilterIconWrapper = styled.div`
  ...
  @media (max-width: 740px) {
    /* Show the filter icon on smaller screens */
    .filter-icon {
      display: block;
      cursor: pointer;
      width: 24px;
...
// Modify the Filters component CSS
const Filters = styled.div`
  ...
  @media (max-width: 740px) {
    display: ${(props) => (props.filtersVisible ? 'block' : 'none')}; /* Show only when filtersVisible is true on mobile */
  }
`;
...
const FilterHeading = styled.div`
  ...
  /* Show the filter icon in mobile */
  @media (max-width: 740px) {
    .filter-icon {
      display:none;
    }
...
const Sort = styled.div`
  ...
  select {
    ...
    @media (max-width: 740px) {
    span:nth-child(2), select {
      display: none;  /* Hide 'Sort by' span and select dropdown */
    }
  }
`;
